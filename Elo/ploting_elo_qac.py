...
elo_data["Model"] = elo_data["Model"].replace({"QRQAC": "QR-QAC", "EQRQAC": "EQR-QAC"})
...
filtered_data = elo_data[elo_data["Model"].isin(["QAC", "QR-QAC", "EQR-QAC"])]
...
x_mapping = {2: 0, 10: 0.7, 50: 1.4, 100: 2.0, 400: 2.6}   # x축 위치 조정
